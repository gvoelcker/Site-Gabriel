...
**9)** The ninth lecture deals with **Uniformly Most Powerful(UMP) Tests**. We keep talking about **bootstraping** here! But then we advance to the UMP, deal with the *Neyman-Pearson Lemma*. In the 3rd part of the lecture we make UMP tests with **composite hypotheses**. Then we perform some **unbiased tests**. Lastly, we talk about the **Likelihood Ratio Test**. 
