...
<center> $\frac{d \phi}{d \alpha_i}$ = $\frac{\partial f}{\partial \alpha_i}$(x($\overline{\rm \alpha}$);$\overline{\rm \alpha}$)

**Proof**: follows directly from the chain rule:

$\frac{d \phi}{d \alpha_i}$ = $\frac{\partial f(x(\overline{\rm \alpha});\overline{\rm \alpha})}{\partial \alpha_i}$ + $\sum_{j = 1}^L$ $\frac{\partial f}{\partial x_j}$ (x($\overline{\rm \alpha}$);$\overline{\rm \alpha}$)$\frac{\partial x_j}{\partial \alpha_i}(\overline{\rm \alpha})$ = $\frac{\partial f (x($\overline{\rm \alpha});$\overline{\rm \alpha})}{\partial \alpha_i}$
...
<center> $s_{ij}$ = $\frac{\partial x_i}{\partial p_j}$ + $\frac{\partial x_i}{\partial w}$ $x_j$
...
$\frac{\partial x_i}{\partial p_j}$(p,w) = $\frac{\partial h_i}{\partial p_j}$(p,$u_0$) - $\frac{\partial x_i}{\partial w}$(p,w)$x_j$(p,w)
...
<center>$x_i(p^{\ast},w^{\ast})$ = -$\frac{\partial v (p^{\ast},w^{\ast})}{\partial p_i}$ / $\frac{\partial v (p^{\ast},w^{\ast})}{\partial w}$
