...
- **Compensating Variation(CV)**: given that the prices have changed, how much the consumer would need to be paid to be as well off? This is formally denoted by:$C V(p_0,p_1,w) = e(p^1, u_1) - e(p^1,u_0) = w - e(p^1,u_0)$. 
...
- **Restric preferences**: simpler function, takes into account only what we think is relevant for our analysis.
