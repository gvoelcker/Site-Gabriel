...
- **Elasticity** of demand with income

: how the demand changes when there is a unit change in income: $\eta_i = \frac{\partial x_i}{\partial w} \times \frac{w}{x_i} = \frac{\partial log x_i}{\partial log w}$.
...
-- **Engel Aggregation**: total expenditure must change by an amount equal to any wealth change. 
