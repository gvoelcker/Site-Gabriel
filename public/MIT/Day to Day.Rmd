...
library(kableExtra)
library(tidyverse)
Task <- c("Micro PS3", "Metrics PS3", "JAE's RR", "Joe's RR", "Harvard's 2nd RR", "Micro", "Metrics")
Goal <- c("10/03", "13/03", "15/03", "29/03", "22/03", "17/03", "18/03")
Deadline <- c("12/03", "16/03", "16/03", "31/03", "25/03", "17/03", "18/03")
Start <- c("03/03", "03/03", "03/03", "19/03", "19/03", "03/03", "03/03")
Status <- c("0%", "0%", "0%", "0%", "0%", "0%", "10%")
Completion <- c(" ", " ", " ", " ", " ", " ", " ")

ApplicationsTable <- as.data.frame(cbind(Task, Goal, Deadline, Start, Status, Completion))
colnames(ApplicationsTable) <- c("Task", "Goal", "Deadline", "Start", "Status", "Completion")
