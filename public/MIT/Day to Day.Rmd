...
library(kableExtra)
library(tidyverse)
Task <- c("Micro PS3", "Metrics PS3", "JAE's RR", "Joe's RR", "Harvard's 2nd RR", "Metrics PS4", "Metrics PS5")
Goal <- c("10/03", "13/03", "15/03", "20/03", "20/03", "18/04", "04/05")
Deadline <- c("12/03", "16/03", "16/03", "31/03", "08/04", "22/04", "08/05")
Start <- c("03/03", "03/03", "03/03", "16/03", "16/03", "12/04", "27/04")
Status <- c("99%", "99%", "100%", "99%", "60%", "0%", "0%")
