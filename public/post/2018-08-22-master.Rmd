...
This last Monday I presented my dissertation and had the pleasure of concluding another cycle: my masters in accounting and finance. The work is entitled: "An Analysis of Risk-Taking in Family Firms", and I was oriented by Prof. PhD. Clea B. Macagnan. 
...
Luckily, a RStudio package has been developed that quickly downloads all the available data upon setting some parameters: GetDFPData. It is possible to obtain all the data via RStudio or [**here**](http://www.msperlin.com/shiny/GetDFPData/). If one is interested in obtaining data from Brazilian companies, this is the best free source of data available, in my opinion. All the information provided has already been translated to English. To access the documentation on the package, just click [**here**](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3128252).(I am currently planning to write a future post about the relevance and particularities of the Brazilian stock market as well as methods of obtaining its information using RStudio)
