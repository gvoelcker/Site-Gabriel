...
```{r Beta, tidy=FALSE, echo=FALSE, message=FALSE, include=FALSE, warning=FALSE}
Fibonacci <- read_excel("Fibonacci.xlsx", sheet="Sheet1", col_names = TRUE)
Graf2 <- ggplot(Fibonacci, mapping = aes(Digit, as.numeric(Distribution))) +
  geom_col() 
Graf2
```
