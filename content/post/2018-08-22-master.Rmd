...
I'd like to acknowledge the contributions of the examination board, which consisted of Profs. PhDs Guilherme Kirch, Cristiano Costa, Roberto Decourt and Daniel Vancin. There is still a lot to work on until this project is published but I'm happy to share for Portuguese speakers the current version of the paper [**here**](https://gabrielvoelcker.netlify.com/FF_Semead.pdf). This version has been approved to the [**Semead Congress **](http://semead.com.br/21/).
