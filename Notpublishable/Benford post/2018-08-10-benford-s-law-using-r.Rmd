...
1/9, right? There are 9 possibilities(1,2,3,4,5,6,7,8,9), since 0 is never a first digit among the possibilities I've described. So, if you chose 4, in 11 of 99 possible outcomes you would've pick correctly. So far, simple math. This is illustrated by the figure below. 
...
But let me ask you now about a different set of numbers: 2^x^, x = {x | 1 < x < 1000}.  Would you say that the odds of guessing correctly would remain 1/9 were you to choose 4 again? Let's see the distribution.
